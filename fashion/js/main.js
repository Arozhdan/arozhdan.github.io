$(function () {
  ...
  $('.menu-home').mouseover(function () {
    $right.css('background-image', "url('/fashion/img/home/header-bg.png')");
  })
  $('.menu-shop').mouseover(function () {
    $right.css('background-image', "url('/fashion/img/menu/shop.png')");
  })
  $('.menu-video').mouseover(function () {
    $right.css('background-image', "url('/fashion/img/menu/video.png')");
  })
  $('.menu-look').mouseover(function () {
    $right.css('background-image', "url('/fashion/img/menu/look.png')");
  })
  $('.menu-about').mouseover(function () {
    $right.css('background-image', "url('/fashion/img/menu/about.png')");
  })
  $('.menu-contact').mouseover(function () {
    $right.css('background-image', "url('/fashion/img/menu/contact.png')");
  })
  var $menu = $('.menu')
